...
@section('content')
    ...
    <div class="glass rounded-2xl overflow-hidden">
        <div class="divide-y divide-gray-200 dark:divide-dark-700/30">
                ...
                <div class="px-6 py-4 flex items-start gap-4 table-row">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-3 mt-1">
                            <span class="text-xs text-gray-500 dark:text-dark-400">{{ $act->created_at->diffForHumans() }}</span>
            ...
            @empty
                <div class="text-center text-gray-500 dark:text-dark-400 py-8">Belum ada aktivitas</div>
            @endforelse
        </div>
        @if($activities->hasPages())
        <div class="px-6 py-4 border-t border-gray-200 dark:border-dark-700/50">{{ $activities->withQueryString()->links() }}</div>@endif
    </div>
@endsection