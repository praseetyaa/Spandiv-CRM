...
<body class="h-full bg-gray-50 dark:bg-dark-950 text-gray-700 dark:text-dark-200">
        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('dashboard') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                ...
                <a href="{{ route('leads.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('leads.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('clients.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('clients.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('services.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('services.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('projects.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('projects.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('subscriptions.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('subscriptions.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('invoices.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('invoices.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('payments.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('payments.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('activities.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('activities.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('users.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('users.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <a href="{{ route('companies.index') }}"
                    class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm {{ request()->routeIs('companies.*') ? 'active' : 'text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
    ...
    @if(session('success'))
        <script>addNotification('success', @json(session('success')));</script>
    @endif
    @if(session('error'))
