        ...
        <div class="glass rounded-2xl p-8">
            <form method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2"><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Judul Project
                    ...
                    <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Harga (Rp) <span
                    ...
                    <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Deadline <span
                    ...
                    @if(isset($project))
                        <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Progress (%)</label><input
                ...
                <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Deskripsi</label><textarea
                        ...
                        class="w-full px-4 py-2.5 bg-gray-100 dark:bg-dark-800/50 border border-gray-300 dark:border-dark-600/50 rounded-xl text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500/50 focus:outline-none">{{ old('description', $project->description ?? '') }}</textarea>
                </div>
