    ...
    <div class="max-w-2xl">
        <div class="glass rounded-2xl p-8">
            <form method="POST"
                ...
                <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Nama Layanan <span
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Kategori <span
                    ...
                    <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Tipe Billing <span
                                class="text-red-400">*</span></label>
                ...
                <div><label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Harga Dasar (Rp) <span
