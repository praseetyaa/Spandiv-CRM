        ...
        <div class="glass rounded-2xl p-8">
            <form method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div><label class="block text-sm font-medium text-dark-300 mb-2">Harga/Bulan (Rp) <span
                                class="text-red-400">*</span></label><input type="number" name="price"
                            value="{{ old('price', $subscription->price ?? '') }}" required
                            class="w-full px-4 py-2.5 bg-dark-800/50 border border-dark-600/50 rounded-xl text-white text-sm focus:ring-2 focus:ring-blue-500/50 focus:outline-none">
                    </div>
                    <div><label class="block text-sm font-medium text-dark-300 mb-2">Billing Cycle</label><select
                            name="billing_cycle"
                            class="w-full px-4 py-2.5 bg-dark-800/50 border border-dark-600/50 rounded-xl text-white text-sm focus:ring-2 focus:ring-blue-500/50 focus:outline-none">
                    ...
                    <div><label class="block text-sm font-medium text-dark-300 mb-2">Tanggal Akhir</label><input type="date"
                            name="end_date"
                    ...
                    <div><label class="block text-sm font-medium text-dark-300 mb-2">Status <span
                            ...
                            class="w-full px-4 py-2.5 bg-dark-800/50 border border-dark-600/50 rounded-xl text-white text-sm focus:ring-2 focus:ring-blue-500/50 focus:outline-none">@foreach(['active' => 'Aktif', 'paused' => 'Paused', 'cancelled' => 'Cancelled'] as $v => $l)
