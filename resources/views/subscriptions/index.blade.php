...
@section('content')
    <div class="glass rounded-2xl overflow-hidden">
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-200 dark:border-dark-700/50">
                    ...
                    <th class="text-left text-xs font-medium text-gray-500 dark:text-dark-400 uppercase px-6 py-4">Layanan</th>
                    <th class="text-left text-xs font-medium text-gray-500 dark:text-dark-400 uppercase px-6 py-4">Harga/Bulan</th>
                    <th class="text-left text-xs font-medium text-gray-500 dark:text-dark-400 uppercase px-6 py-4">Mulai</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-dark-700/30">
                @forelse($subscriptions as $sub)
                    ...
                    <tr class="table-row">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-dark-300">{{ $sub->start_date->format('d M Y') }}</td>
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-dark-700/50">{{ $subscriptions->withQueryString()->links() }}</div>@endif
    </div>
@endsection