    ...
    <div class="max-w-4xl">
        <div class="glass rounded-2xl p-8 mb-6">
            <div class="flex items-start justify-between mb-6">
                <div>
                    <h3 class="text-xl font-bold text-white">{{ $subscription->service->name }}</h3>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-dark-800/50 rounded-xl p-4">
                    <p class="text-xs text-dark-400 mb-1">Harga/Bulan</p>
                ...
                <div class="bg-dark-800/50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-medium text-white">{{ ucfirst($subscription->status) }}</p>
                </div>
                <div class="bg-dark-800/50 rounded-xl p-4">
                    <p class="text-xs text-dark-400 mb-1">Mulai</p>
                    <p class="text-sm text-white">{{ $subscription->start_date->format('d M Y') }}</p>
                </div>
                <div class="bg-dark-800/50 rounded-xl p-4">
                    <p class="text-xs text-dark-400 mb-1">Invoice Count</p>
                    <p class="text-sm text-white">{{ $subscription->invoices->count() }} invoice</p>
                </div>
            </div>
        </div>
